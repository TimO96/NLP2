...
if __name__ == "__main__":
    ...
    modeltask = BertForMaskedLM.from_pretrained('bert-base-dutch-cased').to(device)
    ...
    print('begin task')
    Task(modeltask, model, tokenizer, source_embeds, k=0.7, proj=False)
